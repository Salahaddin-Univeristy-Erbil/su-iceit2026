        ...
        <div class="row">
            ...
            <div class="main-container">
                ...
                <div id="main" class="main-column">
                    <div class="header">
                        Venue, Visa and Travel to Erbil
                    </div>
                    <div class="content">
                        ...
                        <section class="newsletter">
                            ...
                            from ancient times to the present day (source: <a href="https://earthobservatory.nasa.gov/images/144736/history-on-a-hill">NASA</a>,
                            <a href="https://whc.unesco.org/en/list/1437/"> UNESCO</a>). Kurdistan, 
                            operating as a semi-independent state within Iraq according to the Iraqi 
                            constitution (<a href="https://gov.krd">gov.krd</a>), is home to a diverse population of 7 million people. 
                            The region boasts a rich tapestry of ethnicities, including Kurds, Turkmens, 
                            Caldas, Syriacs, and Assyrians, alongside a variety of religious communities, such as Muslims, 
                ...
                <section class="conference-registration">
                    <h2>Taxi</h2>
                    Taxis serve as the predominant mode of public transportation in Erbil. Easily identifiable by their yellow color and marked with a "TAXI" sign, these vehicles are registered with the appropriate authorities, ensuring a high level of safety. Simply raise your hand on the street, and they will stop for you. The fare for a 10-kilometer ride is approximately 4,000 ID (equivalent to 3 US dollars).
                </section>
                </div>
                </div>
            </div>
